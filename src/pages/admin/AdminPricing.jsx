    ...
    <div className="py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold tracking-[-0.01em] text-foreground">Default packages</h1>
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button onClick={() => { setEditing({ ...empty, includes: [] }); setIncludeInput(''); }} className="bg-accent text-accent-foreground font-semibold text-xs hover:bg-accent/90">
                <Plus className="w-4 h-4 mr-2" /> Add package
              </Button>
            </DialogTrigger>
            <DialogContent className="max-w-lg bg-card border-border max-h-[85vh] overflow-y-auto">
              <DialogHeader><DialogTitle>{editing?.id ? 'Edit' : 'Add'} package</DialogTitle></DialogHeader>
              {editing && (
                <div className="space-y-4 mt-4">
                  ...
                  <div>
                    <Label className="text-xs font-semibold">Session length (minutes)</Label>
                  ...
                  <div>
                    <Label className="text-xs font-semibold">Badge (e.g. Most popular)</Label>
                  ...
                  <Button onClick={save} className="w-full bg-accent text-accent-foreground font-semibold hover:bg-accent/90">Save package</Button>
                </div>
              )}
            </DialogContent>
          </Dialog>
